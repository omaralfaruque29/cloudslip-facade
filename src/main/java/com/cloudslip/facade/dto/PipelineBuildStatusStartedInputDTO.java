...
public class PipelineBuildStatusStartedInputDTO extends BaseInputDTO{
    ...
    public PipelineBuildStatusStartedInputDTO() {
    }

    public PipelineBuildStatusStartedInputDTO(ObjectId applicationId, String commitId, PipelineStepStatusType statusType) {
